...
| `AccessToken` | string | required | Access token of the client application. | |
| `Client` | string | required | Name and version of the client application. | |
| `CreatedUtc` | [Time interval](enterprises.md#time-interval) | required | Interval in which the [Transaction](#cashier-transaction) was created. | 3 months |
...
| `StartUtc` | string | optional | Start of the interval in UTC timezone in ISO 8601 format. Required if `ItemIds` are not specified. | 1 month |
| `EndUtc` | string | optional | End of the interval in UTC timezone in ISO 8601 format. Required if `ItemIds` are not specified.  | 1 month |
| `ItemIds` | array of string | optional | Unique identifiers of the Accounting items. Required if `StartUtc` and `EndUtc` are not specified. | 1000 items |
...
| `AccessToken` | string | required | Access token of the client application. | |
| `Client` | string | required | Name and version of the client application. | |
| `BillIds` | array of string | optional | Unique identifiers of the [Bill](finance.md#bill)s. Required if no other filter is provided. | 1000 items |
| `CustomerIds` | array of string | optional | Unique identifiers of the [Customer](customers.md#customer)s. | 1000 items |
...
| `ClosedUtc` | [Time interval](enterprises.md#time-interval) | optional | Interval in which the [Bill](#bill) was closed. | 3 months |
| `CreatedUtc` | [Time interval](enterprises.md#time-interval) | optional | Interval in which the [Bill](#bill) was created. | 3 months |
| `DueUtc` | [Time interval](enterprises.md#time-interval) | optional | Interval in which the [Bill](#bill) is due to be paid. | 3 months |
| `PaidUtc` | [Time interval](enterprises.md#time-interval) | optional | Interval in which the [Bill](#bill) was paid. | 3 months |
...
| `AccessToken` | string | required | Access token of the client application. | |
| `Client` | string | required | Name and version of the client application. | |
| `Bills` | array of [Bill parameters](#bill-parameters) | required | Information about bills to be created. | 1000 items |
...
| `AccessToken` | string | required | Access token of the client application. | |
| `Client` | string | required | Name and version of the client application. | |
| `ConsumedUtc` | [Time interval](enterprises.md#time-interval) | optional | Interval in which the [Outlet item](#outlet-item) was consumed. Required if no other filter is provided. | 3 months |
| `ClosedUtc` | [Time interval](enterprises.md#time-interval) | optional | Interval in which the [Outlet bill](#outlet-bill) was closed. | 3 months |
| `Currency` | string | optional | ISO-4217 code of the [Currency](configuration.md#currency) the item costs should be converted to. | |
...
| `AccessToken` | string | required | Access token of the client application. | |
| `Client` | string | required | Name and version of the client application. | |
| `CreditCardIds` | array of string | optional | Unique identifiers of the [Credit card](finance.md#credit-card)s. Required if no other filter is provided. | 1000 items |
| `CustomerIds` | array of string | optional | Unique identifiers of the [Customer](customers.md#customer)s. | 1000 items |
...
| `AccessToken` | string | required | Access token of the client application. | |
| `Client` | string | required | Name and version of the client application. | |
| `CustomerIds` | array of string | required | Unique identifier of the [Customer](customers.md#customer). | 1000 items |
