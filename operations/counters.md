...
| `CounterIds` | array of string | optional, max 1000 items |  |
| `Type` | [EnterpriseScopeCounterDiscriminator](#X-Ref-Name-EnterpriseScopeCounterDiscriminator) | required | Type of the counter. If not specified, the operation returns all types. |
...
| ~~`BillCounters`~~ | array of [Counter](#Counter) | required | The counters used to count closed [Bills](https://mews-systems.gitbook.io/connector-api/operations/bills/#bill). **Deprecated!** |
| ~~`ProformaCounters`~~ | array of [Counter](#Counter) | required | The counters used to count Pro Forma invoices for [Bills](https://mews-systems.gitbook.io/connector-api/operations/bills/#bill). **Deprecated!** |
| ~~`BillPreviewCounters`~~ | array of [Counter](#Counter) | required | The counters used to count bill previews for [Bills](https://mews-systems.gitbook.io/connector-api/operations/bills/#bill). **Deprecated!** |
...
| `Type` | [EnterpriseScopeCounterDiscriminator](#X-Ref-Name-EnterpriseScopeCounterDiscriminator) | required |  |
