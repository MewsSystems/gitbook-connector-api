...
| `ResourceId` | string | optional | Identifier of [Resource](resources.md#resource) to search by \(members of [Reservation](reservations.md#reservation-2023-06-06) assigned there will be returned\). |
| `Extent` | [Customer extent](#customer-extent) | required | Extent of data to be returned. |
...
| `Reservation` | [Reservation](reservations.md#reservation-2023-06-06) | optional | Reservation of the customer in case he currently stays in the enterprise. |
