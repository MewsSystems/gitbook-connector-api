...
| `ServiceIds` | array of string | optional, max 1000 items | Unique identifiers of [Services](services.md#service) where the age category belong to.If not provided, defaults to all bookable services. |
