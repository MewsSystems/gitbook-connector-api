...
| ~~`ResourceCategories`~~ | ~~array of [Resource category](#resource-category---deprecated)~~ | ~~optional~~ | ~~Categories of resources in the enterprise.~~ **Deprecated!** |
...
#### Resource category - DEPRECATED

| Property | Type | Contract | Description |
| :-- | :-- | :-- | :-- |
| `Id` | string | required | Unique identifier of the category. |
| `IsActive` | bool | required | Whether the category is still active. |
| `Type` | string [Resource category type](#resource-category-type---deprecated) | required | Type of the category. |
...
#### Resource category type - DEPRECATED
