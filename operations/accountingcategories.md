...
| `AccountingCategoryIds` | array of string | optional, max 1000 items | Unique identifiers of the requested [Accounting categories](https://mews-systems.gitbook.io/connector-api/operations/#accounting-category). |
...
| Property | Type | Contract | Description |
| :-- | :-- | :-- | :-- |
| `AccountingCategories` | array of [Accounting category](#AccountingCategory) | optional | Accounting categories of the enterprise. |
...
| `Classification` | string | optional | Classification of the accounting category allowing cross-enterprise reporting. |
