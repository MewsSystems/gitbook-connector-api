...
| `ResourceFeatureAssignmentsIds` | array of string | optional, max 1000 items | Unique identifiers of [Resource feature assignments](resourcefeatures.md#resource-feature-assignment). |
