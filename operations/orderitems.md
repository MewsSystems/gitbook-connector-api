...
| `ServiceOrderIds` | array of string | required, max 1000 items | Unique identifiers of the [Product service orders](productserviceorders.md#product-service-order) or [Reservations](reservations.md#reservation-ver-2023-06-06). Required if no other filter is provided. |
