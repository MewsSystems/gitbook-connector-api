...
| `ServiceOrderIds` | array of string | required, max 1000 items | Unique identifiers of the [Product service orders](productserviceorders.md#product-service-order) or [Reservation](reservations.md#reservation-2023-06-06). Required if no other filter is provided. |
