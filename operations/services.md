...
The price in the response is dependent on the enterprise's [pricing](configuration.md#pricing) setting. If the enterprise is set in a Gross pricing environment, then the prices returned is the gross price (inclusive of tax). If the enterprise is set in a Net pricing environment, the prices returned will be the net price (excluding tax).
...
| `Names` | [Localized text](enterprises.md#localized-text) | required | All translations of the name of the age category. |
