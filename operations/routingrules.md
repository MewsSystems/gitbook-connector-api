...
| `AssignmentTargetType` | string [Assignment target type](routingrules.md#assignment-target-type) | required | Specifies whether the company will be attached as details to the customer bill or used to create a company bill. |
...
| `AssignmentTargetType` | string [Assignment target type](routingrules.md#assignment-target-type) | optional | Specifies whether the company will be attached as details to the customer bill or used to create a company bill. |
...
| `AssignmentTargetType` | [String update value](_objects.md#string-update-value) | optional | Specifies whether the company will be attached as details to the customer bill or used to create a company bill. |
