...
| `AssignmentTargetType` | string [Assignment target type](routingrules.md#assignment-target-type) | optional | Relation of company to the bill. Defaults to CompanyAsDetails. |
...
| `AssignmentTargetType` | [String update value](_objects.md#string-update-value) | optional | Relation of company to the bill [Assignment target type](routingrules.md#assignment-target-type) \(or `null` should it not be updated\). |
