...
| `PersonCounts` | array of [Age category assignment](#age-category-assignment) | required | Number of people per age category the reservation was booked for. At least one category with valid count must be provided. |
...
| `PersonCounts` | array of [Age category assignment](#age-category-assignment) | required | Number of people per age category the reservation is for. At least one category with valid count must be provided. |
| `CustomerId` | string | required | Unique identifier of the [Customer](customers.md#customer) who owns the reservation. |
...
| Property | Type | Contract | Description |
| --- | --- | --- | --- |
| `Value` | array of [Age category assignment](#age-category-assignment) | required | Value which is to be updated. |
