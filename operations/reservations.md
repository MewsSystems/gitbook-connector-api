...
| `TimeUnitPrices` | array of [Time unit price parameters](services.md#time-unit-price-parameters) | optional | Reservation units pricing. e.g Amount of the first and the last night.  |
