...
| `BookerId` | string | optional | Unique identifier of the [Customer](customers.md#customer) on behalf of the reservation was made. |
...
| `BookerId` | [String update value](reservations.md#string-update-value) | optional | Booker of the reservation \(or `null` if the booker should not be updated). |
