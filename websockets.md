...
| `StartUtc` | string | required | Start of the updated interval in UTC timezone in ISO 8601 format. |
| `EndUtc` | string | required | End of the updated interval in UTC timezone in ISO 8601 format. |
