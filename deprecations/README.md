...
| :-- | :-- | :-- | :-- |
| [Get customers open items](../operations/customers.md#get-customers-open-items) | Replaced by [Get all payments](payments.md#get-all-payments) and [Get all order items](orderitems.md#get-all-order-items) | 13 Nov 2024 | - |
