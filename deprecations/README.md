...
| Feature | Comments | Deprecated | Discontinued |
| :-- | :-- | :-- | :-- |
| `AssigneeData` in [Get all bills ](../operations/bills.md#response) | Replaced by [Owner data](../operations/bills.md#bill-owner-data) | 20 Dec 2022 | - |
| `ItalianFiscalCode`, `ItalianFiscalCode` <br>in [Get all bills ](../operations/bills.md#response) | Retrievable in LegalIdentifiers [Bill customer data](../operations/bills.md#bill-customer-data) | 20 Dec 2022 | - |
